$ResourceGroupName= "ArielResourceGroup"
...
$BContext = New-AzStorageContext -StorageAccountName $BStorageAccountName

New-AzStorageContainer -Name $AcontainerName -Context $AContext -Permission blob
New-AzStorageContainer -Name $BcontainerName -Context $BContext -Permission blob
...
Get-ChildItem -Path C:\Users\ariel\Microsoft.Azure\Blobs | Set-AzStorageBlobContent -Container $AcontainerName `
